...
! function(e, n) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], function(t) { return n(t, e, e.document, e.Math) }) : "object" == typeof exports && exports ? module.exports = n(require("jquery"), e, e.document, e.Math) : n(jQuery, e, e.document, e.Math) }("undefined" != typeof window ? window : this, function(e, n, t, o, i) {
    ...
    e.fn.fullpage = function(l) {
        function s(n, t) {
            ...
            var o = e(b);
            l.autoScrolling && !l.scrollBar ? (wt.css({ overflow: "hidden", height: "100%" }), q(Yt.recordHistory, "internal"), Lt.css({ "-ms-touch-action": "none", "touch-action": "none" }), o.length && at(o.position().top)) : (wt.css({ overflow: "visible", height: "initial" }), q(!1, "internal"), Lt.css({ "-ms-touch-action": "", "touch-action": "" }), ft(Lt), o.length && (console.log("llama scroll"), wt.scrollTop(o.position().top), console.log("fiunish scroll"))), Lt.trigger("setAutoScrolling", [n])
        }

        function q(e, n) { gt("recordHistory", e, n) }

        function X(e, n) { "internal" !== n && l.fadingEffect && bt.fadingEffect && bt.fadingEffect.update(e), gt("scrollingSpeed", e, n) }

        function K(e, n) { gt("fitToSection", e, n) }

        function J(e) { l.lockAnchors = e }

        function re(e) { e ? (Jn(), $n()) : (Kn(), et()) }

        function ae(n, t) { "undefined" != typeof t ? (t = t.replace(/ /g, "").split(","), e.each(t, function(e, t) { st(n, t, "m") })) : n ? (re(!0), nt()) : (re(!1), tt()) }

        function le(n, t) { "undefined" != typeof t ? (t = t.replace(/ /g, "").split(","), e.each(t, function(e, t) { st(n, t, "k") })) : l.keyboardScrolling = n }
        ...
        function de(e, n) { X(0, "internal"), fe(e, n), X(Yt.scrollingSpeed, "internal") }

        function fe(e, n) { var t = jn(e); "undefined" != typeof n ? Yn(e, n) : t.length > 0 && Xe(t) }

        function ue(e) { qe("right", e) }

        function he(e) { qe("left", e) }
        ...
        function pe(n) {
            if (!Lt.hasClass(f)) {
                Ot = !0, Mt = ne.height(), e(y).each(function() {
                    var n = e(this).find(F),
                        t = e(this).find(B);
                    l.verticalCentered && e(this).find(T).css("height", Vn(e(this)) + "px"), e(this).css("height", Ce(e(this)) + "px"), l.scrollOverflow && (t.length ? t.each(function() { Pn(e(this)) }) : Pn(e(this))), t.length > 1 && Cn(n, n.find(D))
                });
                var t = e(b),
                    o = t.index(y);
        ...
        function Se() { ne.on("scroll", ze).on("hashchange", fn).blur(Sn).resize(Ln), te.keydown(un).keyup(pn).on("click touchstart", M + " a", wn).on("click touchstart", N, yn).on("click", E, hn), e(y).on("click touchstart", G, mn), l.normalScrollElements && (te.on("mouseenter", l.normalScrollElements, function() { re(!1) }), te.on("mouseleave", l.normalScrollElements, function() { re(!0) })) }
        ...
        function be() {
            Lt.css({ height: "100%", position: "relative" }), Lt.addClass(r), e("html").addClass(u), Mt = ne.height(), Lt.removeClass(f), Ie(), ht("parallax", "init"), e(y).each(function(n) {
                var t = e(this),
                    o = t.find(B),
                    i = o.length;
        ...
        function xe(n, t, o) {
            var i = 100 * o,
                r = 100 / o;
            t.wrapAll('<div class="' + V + '" />'), t.parent().wrap('<div class="' + P + '" />'), n.find(W).css("width", i + "%"), o > 1 && (l.controlArrows && ke(n), l.slidesNavigation && qn(n, o)), t.each(function(n) { e(this).css("width", r + "%"), l.verticalCentered && Fn(e(this)) });
            var a = n.find(D);
            a.length && (0 !== e(b).index(y) || 0 === e(b).index(y) && 0 !== a.index()) ? rt(a) : t.eq(0).addClass(p)
        }

        function Ce(e) { return l.offsetSections && bt.offsetSections ? bt.offsetSections.getWindowHeight(e) : Mt }

        function Ae(n, t) { t || 0 !== e(b).length || n.addClass(p), n.css("height", Ce(n) + "px"), l.paddingTop && n.css("padding-top", l.paddingTop), l.paddingBottom && n.css("padding-bottom", l.paddingBottom), "undefined" != typeof l.sectionsColor[t] && n.css("background-color", l.sectionsColor[t]), "undefined" != typeof l.anchors[t] && n.attr("data-anchor", l.anchors[t]) }

        function Te(n, t) { "undefined" != typeof l.anchors[t] && n.hasClass(p) && zn(l.anchors[t], t), l.menu && l.css3 && e(l.menu).closest(a).length && e(l.menu).appendTo(yt) }

        function Ie() { Lt.find(l.sectionSelector).addClass(w), Lt.find(l.slideSelector).addClass(z) }
        ...
        function Me() {
            e(y).each(function() {
                var n = e(this).find(B);
                n.length ? n.each(function() { Pn(e(this)) }) : Pn(e(this))
            }), Re()
        }

        function Oe() { Lt.find('iframe[src*="youtube.com/embed/"]').each(function() { Ee(e(this), "enablejsapi=1") }) }
        ...
        function ze() { Jt || (requestAnimationFrame(Be), Jt = !0) }
            ...
            if ((!l.autoScrolling || l.scrollBar || ut("dragAndMove")) && !vt()) {
                ...
                if (n = e(d).eq(r), !n.hasClass(p)) {
                    ...
                    var h, v, g = e(b),
                        ...
                        x = n.index(y) + 1,
                        C = n.find(D);
                    C.length && (v = C.data("anchor"), h = C.index()), Ht && (n.addClass(p).siblings().removeClass(p), ht("parallax", "afterLoad"), e.isFunction(l.onLeave) && l.onLeave.call(g, m, x, S), e.isFunction(l.afterLoad) && l.afterLoad.call(n, w, x), l.resetSliders && bt.resetSliders && bt.resetSliders.apply({ localIsResizing: Ot, leavingSection: m }), on(g), en(n), nn(n), zn(w, x - 1), l.anchors.length && (xt = w), Gn(h, v, w, x)), clearTimeout(Ft), Ft = setTimeout(function() { qt = !1 }, 100)
                }
                l.fitToSection && (clearTimeout(Vt), Vt = setTimeout(function() { Ht && l.fitToSection && (e(b).is(n) && (Ot = !0), Xe(e(b)), Ot = !1) }, l.fitToSectionDelay))
            }
            Jt = !1
        }

        function De(e) { var n = e > Gt ? "down" : "up"; return Gt = e, $t = e, n }
        ...
        function Fe(e) { var n = e.originalEvent;!We(e.target) && l.autoScrolling && je(n) && e.preventDefault() }
        ...
        function We(n, t) { t = t || 0; var o = e(n).parent(); return !!(t < l.normalScrollElementTouchThreshold && o.is(l.normalScrollElements)) || t != l.normalScrollElementTouchThreshold && We(o, ++t) }

        function je(e) { return "undefined" == typeof e.pointerType || "mouse" != e.pointerType }
        ...
        function Ye(e, n) { for (var t = 0, i = e.slice(o.max(e.length - n, 1)), r = 0; r < i.length; r++) t += i[r]; return o.ceil(t / n) }
        ...
        function Ge() { e(D).each(function() { rt(e(this), "internal") }) }
        ...
        function Xe(n, t, o) {
            if ("undefined" != typeof n && n.length) {
                var i, r, a = Ue(n),
                    s = { element: n, callback: t, isMovementUp: o, dtop: a, yMovement: Bn(n), anchorLink: n.data("anchor"), sectionIndex: n.index(y), activeSlide: n.find(D), activeSection: e(b), leavingSection: e(b).index(y) + 1, localIsResizing: Ot };
        ...
        function Qe(n) {
            if (l.css3 && l.autoScrolling && !l.scrollBar) {
                ...
                Wn(t, !0), l.scrollingSpeed ? (clearTimeout(Dt), Dt = setTimeout(function() { $e(n) }, l.scrollingSpeed)) : $e(n)
            } else {
                var i = _e(n);
        ...
        function _e(e) { var n = {}; return l.autoScrolling && !l.scrollBar ? (n.options = { top: -e.dtop }, n.element = a) : (n.options = { scrollTop: e.dtop }, n.element = "html, body"), n }

        function Ke(n) { return n.isMovementUp ? n.activeSection.before(n.activeSection.nextAll(y)) : n.activeSection.after(n.activeSection.prevAll(y).get().reverse()), at(e(b).position().top), Ge(), n.wrapAroundElements = n.activeSection, n.dtop = n.element.position().top, n.yMovement = Bn(n.element), n.leavingSection = n.activeSection.index(y) + 1, n.sectionIndex = n.element.index(y), e(a).trigger("onContinuousVertical", [n]), n }

        function Je(n) { n.wrapAroundElements && n.wrapAroundElements.length && (n.isMovementUp ? e(x).before(n.wrapAroundElements) : e(C).after(n.wrapAroundElements), at(e(b).position().top), Ge(), n.sectionIndex = n.element.index(y), n.leavingSection = n.activeSection.index(y) + 1) }

        function $e(n) { Je(n), e.isFunction(l.afterLoad) && !n.localIsResizing && l.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1), l.scrollOverflowHandler.afterLoad(), ht("parallax", "afterLoad"), ut("scrollOverflowReset") && bt.scrollOverflowReset.reset(), l.resetSliders && bt.resetSliders && bt.resetSliders.apply(n), n.localIsResizing || nn(n.element), n.element.addClass(g).siblings().removeClass(g), Ht = !0, e.isFunction(n.callback) && n.callback.call(this) }
        ...
        function rn(n) { var t = n.find(D); return t.length && (n = e(t)), n }
        ...
        function cn(e) {
            ...
            if (!sn(e)) {
                var i, r = "9999999",
                    a = "z-index",
                    l = function() { i = t ? yt.find("div").first() : yt.find("div").last(), i.css(a) !== r && (t ? yt.prepend(n) : yt.append(n)) };
                l(), setInterval(l, 2e3)
            }
        }
        ...
        function un(n) {
            ...
            if (!t.is("textarea") && !t.is("input") && !t.is("select") && "true" !== t.attr("contentEditable") && "" !== t.attr("contentEditable") && l.keyboardScrolling && l.autoScrolling) {
                var o = n.which,
                    i = [40, 38, 32, 33, 34];
                e.inArray(o, i) > -1 && n.preventDefault(), At = n.ctrlKey, Wt = setTimeout(function() { bn(n) }, 150)
            }
        }

        function hn() { e(this).prev().trigger("click") }

        function pn(e) { Et && (At = e.ctrlKey) }

        function vn(e) { 2 == e.which && (eo = e.pageY, Lt.on("mousemove", xn)) }

        function gn(e) { 2 == e.which && Lt.off("mousemove") }
        ...
        function xn(e) { Ht && (e.pageY < eo && zt.m.up ? se() : e.pageY > eo && zt.m.down && ce()), eo = e.pageY }

        function Cn(n, t, o) {
            var i = n.closest(y),
                r = { slides: n, destiny: t, direction: o, destinyPos: t.position(), slideIndex: t.index(), section: i, sectionIndex: i.index(y), anchorLink: i.data("anchor"), slidesNav: i.find(Y), slideAnchor: Xn(t), prevSlide: i.find(D), prevSlideIndex: i.find(D).index(), localIsResizing: Ot };
        ...
        function Tn(n) { bt.continuousHorizontal && bt.continuousHorizontal.afterSlideLoads(n), kn(n.slidesNav, n.slideIndex), n.localIsResizing || (ht("parallax", "afterSlideLoads"), e.isFunction(l.afterSlideLoad) && l.afterSlideLoad.call(n.destiny, n.anchorLink, n.sectionIndex + 1, n.slideAnchor, n.slideIndex), Ht = !0, nn(n.destiny)), Tt = !1, bt.interlockedSlides && bt.interlockedSlides.apply(n) }

        function In(e, n, t) {
            var i = n.destinyPos;
            if (l.css3) {
                var r = "translate3d(-" + o.round(i.left) + "px, 0px, 0px)";
                On(e.find(W)).css(lt(r)), Pt = setTimeout(function() { t && Tn(n) }, l.scrollingSpeed, l.easing)
            } else e.animate({ scrollLeft: o.round(i.left) }, l.scrollingSpeed, l.easing, function() { t && Tn(n) })
        }

        function kn(e, n) { e.find(v).removeClass(p), e.find("li").eq(n).find("a").addClass(p) }
        ...
        function Ln() {
            ...
            } else clearTimeout(Bt), Bt = setTimeout(function() { pe(!0) }, 350)
        }
        ...
        function On(e) { var n = "all " + l.scrollingSpeed + "ms " + l.easingcss3; return e.removeClass(d), e.css({ "-webkit-transition": n, transition: n }) }

        function En(e) { return e.addClass(d) }

        function Hn(n, t) { l.navigation && (e(M).find(v).removeClass(p), n ? e(M).find('a[href="#' + n + '"]').addClass(p) : e(M).find("li").eq(t).find("a").addClass(p)) }

        function Rn(n) { l.menu && (e(l.menu).find(v).removeClass(p), e(l.menu).find('[data-menuanchor="' + n + '"]').addClass(p)) }

        function zn(e, n) { Rn(e), Hn(e, n) }
        ...
        function Dn(e, n) { return e == n ? "none" : e > n ? "left" : "right" }
        ...
        function Fn(e) { e.hasClass(j) || e.addClass(j).wrapInner('<div class="' + A + '" style="height:' + Vn(e) + 'px;" />') }
        ...
        function Wn(e, n) { n ? On(Lt) : En(Lt), Lt.css(lt(e)), setTimeout(function() { Lt.removeClass(d) }, 10) }

        function jn(n) { var t = Lt.find(y + '[data-anchor="' + n + '"]'); return t.length || (t = e(y).eq(n - 1)), t }
        ...
        function Yn(e, n) {
            var t = jn(e);
            t.length && ("undefined" == typeof n && (n = 0), e === xt || t.hasClass(p) ? Nn(t, n) : Xe(t, function() { Nn(t, n) }))
        }
        ...
        function Kn() { t.addEventListener ? (t.removeEventListener("mousewheel", Ne, !1), t.removeEventListener("wheel", Ne, !1), t.removeEventListener("MozMousePixelScroll", Ne, !1)) : t.detachEvent("onmousewheel", Ne) }
        ...
        function $n() { Lt.on("mousedown", vn).on("mouseup", gn) }

        function et() { Lt.off("mousedown", vn).off("mouseup", gn) }
        ...
        function ot() { var e; return e = n.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" } }

        function it(e) { var n = []; return n.y = "undefined" != typeof e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = "undefined" != typeof e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, kt && je(e) && l.scrollBar && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX), n }

        function rt(e, n) { X(0, "internal"), "undefined" != typeof n && (Ot = !0), Cn(e.closest(F), e), "undefined" != typeof n && (Ot = !1), X(Yt.scrollingSpeed, "internal") }
        ...
        function lt(e) { return { "-webkit-transform": e, "-moz-transform": e, "-ms-transform": e, transform: e } }
        ...
        function pt() { return ut("dragAndMove") && bt.dragAndMove.isAnimating }

        function vt() { return ut("dragAndMove") && bt.dragAndMove.isGrabbing }

        function gt(e, n, t) { l[e] = n, "internal" !== t && (Yt[e] = n) }
        ...
        var Bt, Dt, Pt, Ft, Vt, Wt, jt = ot(),
            Zt = { touchmove: "ontouchmove" in n ? "touchmove" : jt.move, touchstart: "ontouchstart" in n ? "touchstart" : jt.down },
            Yt = e.extend(!0, {}, l),
            Nt = {};
    ...
    var ie = {
        ...
        create: function(n, t, o) {
            ...
            i.height(t), i.each(function() {
                ...
                t && e.each(ie.iScrollInstances, function() { e(this).destroy() }), t = new IScroll(n.get(0), o), t.on("scrollEnd", function() { this.fp_isAtTop = this.y > -30, this.fp_isAtEnd = this.y - this.maxScrollY < 30 }), ie.iScrollInstances.push(t), t.wheelOff(), n.data("iscrollInstance", t)
            })
        },
        isScrolled: function(e, n) { var t = n.data("iscrollInstance"); return !t || ("top" === e ? t.y >= 0 && !n.scrollTop() : "bottom" === e ? 0 - t.y + n.scrollTop() + 1 + n.innerHeight() >= n[0].scrollHeight : void 0) },
        scrollable: function(e) { return e.find(F).length ? e.find(D).find(s) : e.find(s) },
